...
typedef enum t_audio_track_cause
{
    ...
    AUDIO_TRACK_CAUSE_HW_ERROR              = 0x01, /**< Audio track that encouterred low layer hardware error. */
    AUDIO_TRACK_CAUSE_BUFFER_EMPTY          = 0x02, /**< Audio track that encouterred buffer empty. */
    AUDIO_TRACK_CAUSE_REMOTE_JOIN_FAILED    = 0x03, /**< Audio track that encouterred remote join failure. */
    AUDIO_TRACK_CAUSE_JOIN_PACKET_LOST      = 0x04, /**< Audio track that encouterred too many packets lost. */
    AUDIO_TRACK_CAUSE_UNKNOWN_ERROR         = 0xFF, /**< Audio track that encouterred unknown error. */
} T_AUDIO_TRACK_CAUSE;
 ...
 *
 * \param[in] handle    The Audio Track session handle \ref T_AUDIO_TRACK_HANDLE.
 * \param[in] volume    The volume in level of the Audio Track session.
 *
