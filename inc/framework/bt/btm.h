...
typedef enum t_bt_event
{
    ...
    */
    ...
    /**
     * \brief Indicate romote connection fail \ref T_BT_EVENT_PARAM_REMOTE_CONN_FAIL.
     */
...
typedef struct t_bt_event_param_remote_name_rsp
{
    ...
    char       *name;                       /**< Buffer of remote device's name */
