 ...
 * bt_a2dp.h
 *
 * \brief  Set A2DP stream endpoint.
 *
 * \param[in] sep   A2DP stream end point \ref T_BT_A2DP_STREAM_ENDPOINT.
 *
 * \return          The status of seting A2DP stream endpoint.
 * \retval true     A2DP stream endpoint was set successfully.
 * \retval false    A2DP stream endpoint was failed to set.
 *
 * \ingroup BT_A2DP
 */
bool bt_a2dp_stream_endpoint_set(T_BT_A2DP_STREAM_ENDPOINT sep);
