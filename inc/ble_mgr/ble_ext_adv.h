 ...
 * \code{.c}
    ...
    {   //common_adv_data and scan_rsp_data shall point to a global memory.
...
/**
*@brief used to create adv handle and initial adv param, adv data, scan response data and random address before gap stack ready
*@note
*@param[out] adv_handle  ble adv handle, each adv set has a adv handle
*@param[in]  adv_event_prop  @ref T_LE_EXT_ADV_LEGACY_ADV_PROPERTY
...
/**
*@brief used to update adv tx power, this api shall be used after gap stack init ready
*@note
*@param[in] adv_handle  ble adv handle, each adv set has a adv handle
...
/**
*@brief used to update adv_event_prop, this api shall be used after gap stack init ready
*@note
*@param[in] adv_handle  ble adv handle, each adv set has a adv handle
*@param[in] adv_event_prop  @ref T_LE_EXT_ADV_LEGACY_ADV_PROPERTY
*@return    T_GAP_CAUSE
...
/**
*@brief used to update primary and secondary adv phy, this api shall be used after gap stack init ready
*@note
*@param[in] adv_handle  ble adv handle, each adv set has a adv handle
