...
typedef enum t_sport_bclk_ratio
{
    SPORT_BCLK_RATIO_PLL_64_FS = 4,
    SPORT_BCLK_RATIO_PLL_256_FS = 1,
    SPORT_BCLK_RATIO_XTAL = SPORT_BCLK_RATIO_PLL_64_FS,
} T_SPORT_BCLK_RATIO;
...
{
    T_SPORT_SR tx_sample_rate;
    T_SPORT_SR rx_sample_rate;
    ...
    uint8_t tx_fifo_used; // bit map, T_SPORT_FIFO_USE
    uint8_t rx_fifo_used; // bit map, T_SPORT_FIFO_USE
...
void sport_drv_trx_config_get(T_SPORT_ID id, T_SPORT_TRX_CFG *config);
...
void sport_drv_data_sel_config_get(T_SPORT_ID id, T_SPORT_DATA_SEL_CFG *config);
...
void sport_drv_misc_config_get(T_SPORT_ID id, T_SPORT_MISC_CFG *config);
