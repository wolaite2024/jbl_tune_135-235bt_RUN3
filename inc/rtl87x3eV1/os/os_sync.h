 ...
 * \ingroup  OS_87x3e_Synchronization
 */
extern bool (*os_sem_create_intern)(void **pp_handle, uint32_t init_count, uint32_t max_count);
#define os_sem_create(pp_handle, p_name, init_count, max_count) os_sem_create_intern(pp_handle, init_count, max_count)
/**
 * os_sync.h
 *
...
bool os_sem_create_rom(void **pp_handle, uint32_t init_count, uint32_t max_count);
