...
extern bool (*os_msg_queue_create_intern)(void **pp_handle, uint32_t msg_num, uint32_t msg_size,
...
bool os_msg_queue_create_intern_rom(void **pp_handle, uint32_t msg_num, uint32_t msg_size,
                                    const char *p_func, uint32_t file_line);
