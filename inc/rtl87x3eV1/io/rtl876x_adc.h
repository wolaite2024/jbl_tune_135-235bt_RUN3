...
#define IS_ADC_CHANNEL(ch)      (ch<=ADC_7)
...
/** End of Group ADC_Exported_Types
  * @}
  */
/** @defgroup ADC_CONVERT_TIME   ADC convert time, default is 0.
  * @{
  */
...
#define INTERNAL_VDDCORE_MODE                       ((uint16_t)((0x02 << 3) | 0x02))
#define INTERNAL_VCORE_MODE                         ((uint16_t)((0x02 << 3) | 0x03))
#define INTERNAL_ICHARGE_MODE                       ((uint16_t)((0x02 << 3) | 0x04))
#define INTERNAL_IDISCHG_MODE                       ((uint16_t)((0x02 << 3) | 0x05))
#define INTERNAL_ICHGM1_MODE                        ((uint16_t)((0x02 << 3) | 0x06))
#define INTERNAL_VDDIO_MODE                         ((uint16_t)((0x02 << 3) | 0x07))
...
#define IS_ADC_SCHEDULE_INDEX_CONFIG(CONFIG) ((((CONFIG) & 0xFFE0) ==0) && ((((~(CONFIG)) & (0x18)) !=0)\
                                                                            ...
                                                                            || ((CONFIG) == INTERNAL_VDDCORE_MODE) || ((CONFIG) == INTERNAL_ICHARGE_MODE)\
                                                                            || ((CONFIG) == INTERNAL_IDISCHG_MODE) || ((CONFIG) == INTERNAL_ICHGM1_MODE)\
                                                                            || ((CONFIG) == INTERNAL_VDDIO_MODE)))

/** End of Group ADC_Exported_Types
  * @}
  */

/** @defgroup ADC_Clock_Config ADC Sample clock
  * @{
  */
...
/*  adc sample clock frequence default value as follow */
...
#define ADC_CLK_19_5K                          0x14
#define ADC_CLK_9_8K                           0x13
#define ADC_CLK_4_88K                          0x12
#define ADC_CLK_2_44K                          0x11
#define ADC_CLK_1_22K                          0x10
...
/** @defgroup ADC_Data_Minus ADC data minuses the offset before writes to reg/fifo
  * @{
  */
...
/** @defgroup ADC_Power_mode ADC Power Mode  0x50 bit 19 adc_manual_poweron
  * @{
  */
...
/** @defgroup ADC_one_shot_fifo data to be written into fifo in one-shot mode CR 0x04 bit 27
  * @{
  */

#define ADC_ONE_SHOT_FIFO_ENABLE                             ((uint32_t)(1 << 27))

/** End of Group ADC_one_shot_fifo
  * @}
  */

/** @defgroup ADC_over_write_enable ADC FIFO Over Write  CR 0x04 bit 13
  * @{
  */
...
/** End of  ADC_FIFO_STOP_WRITE
  * @}
  */
/** @defgroup ADC_power_always_on_cmd ADC power always on cmd  0x 50 bit15  adc_poweron_only_en
  * @{
  */
...
/**
  * @brief  Read the EXT_SINGLE_ENDED_DIVIDE mode resistance value,The value read out is the value of resistance,
            which needs to be added separately, and the unit is k ohm.
  * @param  None.
  * @retval Resistance value,the unit is k ohm.
  * @note   If the return value is less than zero, the value read is invalid.
  */
int16_t ADC_GetResistance(void);
