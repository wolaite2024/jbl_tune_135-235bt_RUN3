 ...
 * @param  pBuf : bytes to be transmitted SPI_DataSize = SPI_DataSize_8b is required.
...
/**
  ...
  * @param  SPIx: where x can be 0 or 1
  * @param  pBuf : words to be transmitted SPI_DataSize = SPI_DataSize_32b is required.
...
/**
   ...
   * @param  SPIx: where x can be 0 or 1
   * @param  pBuf : Halfwords to be transmitted ,  SPI_DataSize = SPI_DataSize_16b is required .
...
/**
  ...
  * @param  SPIx: where x can be 0 or 1
  * @param  Data : Data to be transmitted ,need notice  SPI_DataSize if SPI_DataSize = SPI_DataSize_8b only last 8bits of Data be sent.
  * @retval None
  */
