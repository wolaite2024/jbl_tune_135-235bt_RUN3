...
/** @defgroup RCC_Peripheral_Clock  RCC Peripheral Clock
  * @{
  */
/*start  offset address  28| --> bit28, (0x01 << 29) --> adress 0x230,(0x02 << 29) -->0x234, 0x00 << 10) -->0x00 double clock? */
...
#define APBPeriph_ISO7816_CLOCK           ((uint32_t)( 10 | (0x03 << 29) | (0x00 << 10)))
...
|| ((CLOCK) == APBPeriph_SIMC_CLOCK) || (CLOCK) == (APBPeriph_ISO7816_CLOCK)\
...
#define APBPeriph_ISO7816               ((uint32_t)( 4  | (0x02 << 26)))
...
#define IS_APB_PERIPH(PERIPH) (((PERIPH) == APBPeriph_CAP) || ((PERIPH) == APBPeriph_AAC_XTAL)\
                               ...
                               || ((PERIPH) == APBPeriph_IF8080) || ((PERIPH) == APBPeriph_ISO7816)\
...
/** @defgroup TIM_Clock_Divider UART Clock Divider
  * @{
  */
...
void RCC_TimSourceConfig(uint16_t clocklevel, uint16_t clocksource,
                         FunctionalState NewState);
