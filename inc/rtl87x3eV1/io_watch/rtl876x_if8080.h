...
/**
 * \brief   Enable the IF8080 output pin group.
            IF8080_PinGroup : CS(P2_3), DCX(P2_4), WR(P2_5), RD(P2_1), Vsync(P2_2)
            D0(P2_6), D1(P2_7), D2(P4_0), D3(P4_1), D4(P4_2), D5(P4_3), D6(P4_4), D7(P4_5)
 * \param   None.
 * \return None.
 *
 * <b>Example usage</b>
...
/**
  * \brief  Send multi command and data buffer in manual mode.
  * \param  pCmdBuf: command sequence buffer.
  * \param  cmd_num: command num.
  * \param  pBuf: buffer address to be sent.
  * \param  len:  data length.
  * \retval None.
  */
void IF8080_WriteWithMultiCmd(uint8_t *pCmdBuf, uint8_t cmd_num, uint8_t *pBuf, uint32_t len);
