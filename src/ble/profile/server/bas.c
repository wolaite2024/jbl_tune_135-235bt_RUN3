...
#if F_APP_GATT_SERVER_EXT_API_SUPPORT
        return server_ext_attr_read_confirm(le_get_conn_handle(conn_id), L2C_FIXED_CID_ATT, service_id,
                                            GATT_SVC_BAS_BATTERY_LEVEL_INDEX,
                                            &battery_level, sizeof(battery_level), sizeof(battery_level), APP_RESULT_SUCCESS);
#else
