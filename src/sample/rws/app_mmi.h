...
typedef enum
{
    ...
    */
    ...
    MMI_CIG_START   = 0xE2,
    MMI_CIG_STOP    = 0xE3,
    MMI_CIG_HF_CANCEL_VOICE_DIAL    = 0xE5,
    MMI_CIG_HF_REJECT_CALL    = 0xE6,
    MMI_CIG_HF_END_OUTGOING_CALL    = 0xE7,
    MMI_CIG_HF_END_ACTIVE_CALL    = 0xE8,
...
extern void (*app_mmi_voice_recognition_enable_hook)(void);
extern void (*app_mmi_voice_recognition_disable_hook)(void);
extern void (*app_mmi_av_play_pause_hook)(void);
extern void (*app_mmi_av_fwd_hook)(void);
extern void (*app_mmi_av_bwd_hook)(void);
extern void (*app_mmi_listening_cycle_hook)(void);
extern void (*app_anc_apt_tone_check_hook)(bool *);
extern void (*app_mmi_enter_pairing_hook)(void);
#endif
