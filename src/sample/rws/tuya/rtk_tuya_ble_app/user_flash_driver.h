...
*/
RAM_TEXT_SECTION __STATIC_INLINE void spic_enable(uint32_t enable)
{
    SPIC->ssienr = enable;
}
 ...
 * @return
*/
RAM_TEXT_SECTION __STATIC_INLINE void spic_clr_multi_ch(void)
{
 ...
 * @return
*/
RAM_TEXT_SECTION __STATIC_INLINE void spic_set_rx_mode(void)
{
...
*/
RAM_TEXT_SECTION __STATIC_INLINE void spic_set_dr(T_SPIC_BYTE_NUM byte_num, uint32_t data)
{
    uint32_t wr_data;
...
*/
RAM_TEXT_SECTION __STATIC_INLINE uint32_t spic_get_dr(T_SPIC_BYTE_NUM byte_num)
{
    uint32_t rd_data = 0;
    if (byte_num == DATA_HALF)
    {
...
RAM_TEXT_SECTION __STATIC_INLINE uint32_t flash_auto_read(uint32_t addr)
{
 ...
 * @return
*/
RAM_TEXT_SECTION __STATIC_INLINE void spic_set_multi_ch(uint32_t data_ch, uint32_t addr_ch)
{
    SPIC->ctrlr0 &= ~(BIT_CMD_CH(3) | BIT_ADDR_CH(3) | BIT_DATA_CH(3));
 ...
 * @return
*/
RAM_TEXT_SECTION __STATIC_INLINE void spic_set_tx_mode(void)
{
    SPIC->ctrlr0 &= ~(BIT_TMOD(3));
}
...
*/
RAM_TEXT_SECTION __STATIC_INLINE bool spic_wait_busy(void)
{
    uint32_t ctr = 0;
