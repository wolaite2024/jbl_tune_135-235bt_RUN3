...
extern T_SIDETONE_CFG sidetone_cfg;
...
/**
 *
 * \brief   Set app cfg gain level.
 *
 */
void eq_utils_hw_sidetone_param_get(T_SIDETONE_CFG *sidetone_cfg);
...
*
*/
uint8_t eq_utils_stage_num_get(uint16_t info_len, T_EQ_DATA_DEST eq_data_dest,
