...
/**
 * @brief gfps_finder_get_adv_state
 *  get gfps finder adv state @ref T_BLE_EXT_ADV_MGR_STATE
 * @return T_BLE_EXT_ADV_MGR_STATE
 */
T_BLE_EXT_ADV_MGR_STATE gfps_finder_get_adv_state(void);
...
/**
 * @brief gfps_finder_update_adv_ei_hash
...
/**
 * @brief get key press to stop tracking flag
 *
 * @return true
 * @return false
 */
