...
typedef struct _uac2_ac_itf_hdr_desc
{
    uint8_t  bLength;
...
typedef struct _uac2_as_itf_desc
{
    uint8_t   bLength;
    uint8_t   bDescriptorType;
    uint8_t   bDescriptorSubtype;
...
#define T_UAC2_STD_ITF_DESC     T_USB_ITF_DESC
#define T_UAC2_STD_EP_DESC      T_USB_EP_DESC
#pragma pack(pop)

void usb_audio2_descs_register(void);
