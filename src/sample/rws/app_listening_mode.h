...
/*                NEW_FORMAT_LISTENING_CMD_REPORT FORMAT

            support                                        discard
   ----------------------------             ----------------------------------
   CMD_LISTENING_STATE_SET                  CMD_ANC_ENABLE_DISABLE(for phone)
   CMD_LISTENING_STATE_STATUS               CMD_LLAPT_ENABLE_DISABLE
   EVENT_LISTENING_STATE_SET                EVENT_REPORT_STATUS(for ANC)
   EVENT_LISTENING_STATE_STATUS             EVENT_REPORT_STATUS(for APT)
*/
#define NEW_FORMAT_LISTENING_CMD_REPORT      1

#define LISTENING_EVENT_NUM                  10
...
#define APP_LISTENING_EVENT_EITHER_OUT_EAR   5    /*  0x0020  */
