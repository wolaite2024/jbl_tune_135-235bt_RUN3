...
{
    void                        *timer_handle;
    void                        *put_data_timer_handle;
    uint8_t                     timer_queue_id;
    uint8_t                     put_data_timer_queue_id;
...
//    PLAYBACK_REMOTE_MSG_STARTED_SYNC                    = 0x02,
    PLAYBACK_REMOTE_MSG_PUT_DATA_SYNC                   = 0x03,
//    PLAYBACK_REMOTE_MSG_FREE_SYNC                       = 0x04,
    PLAYBACK_REMOTE_MSG_PRI_STARTED_SYNC                = 0x05,
    PLAYBACK_REMOTE_MSG_SEC_STARTED_SYNC                = 0x06,
    PLAYBACK_REMOTE_MSG_CHECK_FILE_SYNC                 = 0x07,
    PLAYBACK_REMOTE_MSG_CHECK_RESULT_SYNC               = 0x08,
    PLAYBACK_REMOTE_MSG_SINGLE_COUPLE_PRI_SYNC          = 0x09,
    PLAYBACK_REMOTE_MSG_SINGLE_COUPLE_SEC_SYNC          = 0x0A,
    PLAYBACK_REMOTE_MSG_STOP_SYNC                       = 0x0B,
    PLAYBACK_REMOTE_MSG_RESUM_SYNC                      = 0x0C,
    PLAYBACK_REMOTE_MSG_PLAYLIST_SYNC                   = 0x0D,
    PLAYBACK_REMOTE_MSG_TRACK_STOP_SYNC                 = 0x0E,
    PLAYBACK_REMOTE_MSG_SEC_TRACK_STOPPED_SYNC          = 0x0F,
...
//typedef enum
//{
#define PLAYBACK_TIMER_SD_INIT                      0x00
#define PLAYBACK_TIMER_SIGNLE_TO_COUPLE_SYNC        0x01
#define PLAYBACK_TIMER_QUIT_HFP                     0x02
#define PLAYBACK_TIMER_AUDIO_START                  0x03
#define PLAYBACK_TIMER_AUDIO_STOP                   0x04
#define PLAYBACK_TIMER_PUT_DATA                     0x05
//} T_PLAYBACK_TIMER;
#define PLAYBACK_TIMER_SD_POWER_DOWN                0x00
#define PLAYBACK_TIMER_DLPS_DISABLE                 0x00
