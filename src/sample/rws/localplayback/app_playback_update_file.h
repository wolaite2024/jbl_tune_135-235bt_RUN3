...
#define PLAYBACK_SD_ACTIVE_TIME_OUT             2
...
typedef enum
{
    PB_TIMER_PLAYBACK_TRANS,
    PB_TIMER_RWS_SYNC,
    PB_TIMER_TSPP_PLAYBACKL,
} T_SPP_PLAYBACK_TIMER;
typedef enum
{
    PB_TIMER_FILE_TRANS,
} T_SPP_PLAYBACK_FILE_TIMER;
...
{
    void *timer_handle_pb_up_transfer;
    void *timer_handle_file_trans;
    void *timer_handle_sd_active;
    ...
    uint16_t file_id;
    uint8_t bd_addr[6];
    uint8_t timer_upstream_queue_id;
    uint8_t trans_mode;
    SPP_IDX_BLE_CONN_ID id;

    uint8_t file_timer_queue_id;
    uint8_t sd_active_timer_queue_id;
...
//-------------------------------ble------------------------------//
/** @brief  BLE_PLAYBACK timer callback */
typedef enum
{
    PB_TIMER_BLE_UP_FILE_TRANS,

} T_BLE_PLAYBACK_TIMER;
