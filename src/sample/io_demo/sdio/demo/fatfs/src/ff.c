...
)
{
    ...
    res = dir_sdi(dp, (dp->lfn_idx == 0xFFFF) ? i :
...
)
{
    ...
    UINT rcnt, cc;
    BYTE csect = 0, *rbuff = (BYTE *)buff;  //Renee: add csect initialization to avoid CPP Check error
...
)
{
    ...
    BYTE csect = 0; //Renee: Add csect initialization to avoid CPP Check error
