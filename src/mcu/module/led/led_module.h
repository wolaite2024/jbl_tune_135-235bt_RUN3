 ...
 */
extern void led_reset_sleep_led(void);

/**
 * @brief Clear Sleep LED registers of specified channel
 */
extern void led_deinit(T_LED_CHANNEL channel);
...
/**
  ...
  * @retval None
  */
extern void led_config(T_LED_CHANNEL channel, T_LED_TABLE *table);

/**
  * @brief  set the driver mode according the config setting.
  * @retval None
  */
extern void led_set_driver_mode(void);

/**
 * @brief whether pinmux is sleep pinmux
 */
extern bool led_is_sleep_pinmux(uint8_t pinmux);
